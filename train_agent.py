...
if __name__ == "__main__":
    ...
    parser.add_argument("--data-path", type=str, default="./adata/train/raw")
    parser.add_argument("--data-path-gt", type=str, default="./adata/train/gt")
    parser.add_argument("--data-path-val", type=str, default="./adata/val")
